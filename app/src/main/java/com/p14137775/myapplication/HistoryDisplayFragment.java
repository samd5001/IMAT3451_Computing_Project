...
public class HistoryDisplayFragment extends Fragment{
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup parent, Bundle savedInstanceState) {
        ...
        records = new SQLWrapper(getActivity().getApplicationContext(), getActivity().getSharedPreferences("preferences", Context.MODE_PRIVATE)).getRecords(getArguments().getString("exerciseName"));
